// List data type modified for A3
// You may modify this file as needed; however,
// you may *NOT* modify the function prototypes or constant names.
//creating double linked list; ALL THE NODE CREATING FUNCTIONS NOW TAKE SIZE_T T
...
struct Node_s {
    size_t size;
    void* item; //start address of memory chunk
    Node* next;
    Node* prev;
}; 
...
struct List_s{
	...
	Node* tail; 
	Node* curr; //current 
	enum ListOutOfBounds bounds; //to track if it is out of bounds
